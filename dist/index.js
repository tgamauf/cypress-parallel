...
const parsing_1 = __importDefault(__nccwpck_require__(791));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        yield (0, parsing_1.default)();
    });
}
...
exports.DEFAULT_INTEGRATION_FOLDER = DEFAULT_INTEGRATION_FOLDER;
const DEFAULT_TEST_FILES = "**/*.*";
exports.DEFAULT_TEST_FILES = DEFAULT_TEST_FILES;
function parse() {
    return __awaiter(this, void 0, void 0, function* () {
        const config = {
        ...
        try {
            ...
            (0, core_1.info)(`Integration tests found: ${JSON.stringify(integrationTests)}`);
            if (componentTests) {
                (0, core_1.setOutput)("component-tests", componentTests);
                (0, core_1.info)(`Component tests found: ${JSON.stringify(componentTests)}`);
            }
        }
        catch (e) {
...
function parseTests(config, cypressConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        const integrationTests = yield parseTestOfType(config, cypressConfig.integrationFolder, cypressConfig.testFiles, cypressConfig.ignoreTestFiles);
        let componentTests;
        if (cypressConfig.componentFolder) {
            componentTests = yield parseTestOfType(config, cypressConfig.componentFolder, cypressConfig.testFiles, cypressConfig.ignoreTestFiles);
        }
        return { integrationTests, componentTests };
    });
}
function parseTestOfType(config, testFolder, testFiles, ignoreTestFiles) {
    return __awaiter(this, void 0, void 0, function* () {
        const globPattern = createGlobPattern(testFolder, testFiles, ignoreTestFiles);
        const globber = yield (0, glob_1.create)(globPattern, { followSymbolicLinks: config.followSymbolicLinks });
        return yield globber.glob();
    });
}
function createGlobPattern(testFolder, testFiles, ignoreTestFiles) {
